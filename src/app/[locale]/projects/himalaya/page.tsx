...
import HimalayaClient from './himalaya-client'
...
export default async function Himalaya({ params: { locale } }: Props) {
  unstable_setRequestLocale(locale)
  const images: ImageProps[] = await getImagesFromCloudinary('himalaya')
  const t = await getTranslations('Himalaya')
